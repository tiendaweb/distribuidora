<header class="bg-gradient-to-r from-amber-50 via-yellow-50 to-white sticky top-0 z-40 shadow-md border-b border-amber-200">
  <div class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
    <button
      ...
      class="hidden lg:flex items-center justify-center w-10 h-10 rounded-lg bg-blue-100 hover:bg-blue-200 text-blue-600 hover:text-blue-700 transition-all duration-200"
      title="Expandir / Colapsar menú de administración"
