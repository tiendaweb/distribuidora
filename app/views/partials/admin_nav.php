...
@media (min-width: 1024px) {
    ...
    body.admin-nav-present.admin-nav-collapsed {
...
(function() {
    ...
    // Restaurar estado guardado ANTES de que se pinte el DOM
    if (localStorage.getItem(storageKey) === '1' && window.innerWidth >= 1024) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Mostrar botón en el header si existe
    if (btnHeader) {
        btnHeader.classList.replace('hidden', 'flex');
    }
