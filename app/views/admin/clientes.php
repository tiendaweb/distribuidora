    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div class="bg-white rounded-xl shadow-sm p-5 h-fit">
        ...
        <div class="space-y-3">
          ...
          <input type="text" id="c-code" placeholder="Código de cliente" class="w-full border rounded p-2 text-sm">
      ...
      <div class="md:col-span-2 bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="overflow-x-auto"><table class="w-full admin-table"><thead><tr><th>Nombre</th><th>Código</th><th>Dirección</th><th>CUIT</th><th>Condición</th><th class="text-right">Acción</th></tr></thead><tbody id="admin-clients-tbody"></tbody></table></div>
      </div>
