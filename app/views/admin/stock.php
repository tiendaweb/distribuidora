    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
      <div class="p-4 border-b bg-gray-50 flex flex-col sm:flex-row justify-between sm:items-center gap-2">
        ...
        <div class="flex items-center gap-2">
          <a href="/admin/bulk-edit" class="bg-green-600 hover:bg-green-700 text-white font-bold text-xs px-3 py-2 rounded-lg flex items-center gap-2">
            <i class="fas fa-table-list"></i> Edición Masiva
          </a>
